...
export const getEmptyCardMessage = (filterType) => {
    switch(filterType){
        case "search":
            return `Oops! No stories found matching your research.`;

        case "date":
            return `No stories found in the given date range.`;

        default:
            return `Start creating your first Travel Story! Click the 'Add' button to join down
                your thought, ideas, and memories. Let's get started`;
    }
};
