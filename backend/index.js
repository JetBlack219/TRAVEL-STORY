...
// Get current directory path equivalent to __dirname in ES Modules
...
mongoose.connect(userData.connectionString)
...
app.delete("/delete-image", async (req, res) => {
    ...
    try {
        ...
        // Define the file path using path.join
...
app.post("/add-travel-story", authenticateToken, async (req, res) => {
    ...
    // Convert visitedDate from milliseconds to Date objects
...
app.put("/edit-story/:id", authenticateToken, async(req, res) => {
    ...
    try{
        ...
        const placeholderImgUrl = `hhtp://localhost:8000/assets/placeholder.png`;
...
app.delete("/delete-story/:id", authenticateToken, async(req, res) => {
    ...
    try{
        ...
        res.status(200).json({message: "Travel story deleted successful"})
    } catch(error){
        res.status(500).json({error: true, message: error.message});
    }
});
